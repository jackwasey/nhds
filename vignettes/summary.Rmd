...
# NHDS and Comorbidities

Inspired by question from Abhishek Deshpande:

```{r hypertensioncharlson}
nhds <- nhds::nhds_adult()
nhds$hypertension <- icd::comorbid_ahrq(nhds)[, "HTN"]
nhds$charlson <- icd::charlson(nhds)
hist(nhds[["age_years"]],
     main = "Age of adult NHDS patients", 
     xlab = "Age in years")
boxplot(age_years ~ hypertension, 
        data = nhds,
        outline = FALSE,
        ylab = "Age")
